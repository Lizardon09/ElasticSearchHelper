...
dotnet pack ../ElasticSearchHelper.Infrastructure/ElasticSearchHelper.Infrastructure.csproj -o ../bin/Publish/Nuget/
cleanecho -e 'project packaging successfull...\n'

cleanecho -e '\nattempting package push to nuget.org...'
#Push nuget package with api key
nuget push ../bin/Publish/Nuget/DragonCore.ElasticSearchHelper.${proj_version}.nupkg $apiKey -Source https://api.nuget.org/v3/index.json
